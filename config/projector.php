    ...
    */
    ...
    'options' => [
        ...
        'default' => [
            ...
            ProjectionOption::RETRIES => '10, 2000, 10',
            ProjectionOption::DETECTION_WINDOWS => null,
        ],

        'lazy' => [
            ProjectionOption::SIGNAL => true,
            ProjectionOption::LOCKOUT => 2000000,
            ProjectionOption::SLEEP => 2000000,
            ProjectionOption::TIMEOUT => 2000000,
        ...
        'emit_slow' => [
            ProjectionOption::SIGNAL => true,
            ProjectionOption::LOCKOUT => 50000000,
            ProjectionOption::SLEEP => 1000000,
            ProjectionOption::TIMEOUT => 1000000,
            ProjectionOption::BLOCK_SIZE => 1000,
