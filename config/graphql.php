...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\Api\Graphql\CustomersFromIncludedPositionQuery::class,
            ],
            'mutation' => [
            ...
            'types' => [
                \App\Api\Graphql\EventStoredType::class,
                \App\Api\Graphql\ContentType::class,
                \App\Api\Graphql\HeaderType::class,
            ],
